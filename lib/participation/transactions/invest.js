...
const invest = async (
  ...
  const assetAddress = isNativeAsset
    ? await fundContract.instance.NATIVE_ASSET.call()
    : await fundContract.instance.QUOTE_ASSET.call();

  const symbol = getSymbol(assetAddress);
