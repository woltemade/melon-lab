...
const subscribe = async (
  ...
  console.log(findEventInLog("LogRequest", receipt));
  /* eslint-disable no-underscore-dangle */
  const requestObj = await fundContract.requests[
    subscribeRequestLogEntry.args.requestId
  ];
  console.log("Request ID -- ", subscribeRequestLogEntry.args.requestId);
  console.log("Request from mapping -- ", requestObj);
  return {
